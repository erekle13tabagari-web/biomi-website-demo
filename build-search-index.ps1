...
$staticKa = @(
  ...
  @{ url = 'projects.html'; title = 'გამორჩეული პროექტები'; kind = 'გვერდი' },
  # hidden for now: @{ url = 'service.html';                  title = 'სერვისი და ტექნიკური მხარდაჭერა'; kind = 'გვერდი' },
  @{ url = 'products/heating.html';         title = 'გათბობა';               kind = 'კატეგორია' },
  @{ url = 'products/ducting-fittings.html'; title = 'ჰაერსატარი და მაკომპლექტებელი'; kind = 'კატეგორია' },
  @{ url = 'products/ducting.html';         title = 'ჰაერსატარი';            kind = 'კატეგორია' },
  @{ url = 'products/grilles.html';         title = 'ცხაურა';                kind = 'კატეგორია' },
  @{ url = 'products/accessories.html';     title = 'ჰაერსატარის აქსესუარები'; kind = 'კატეგორია' },
  ...
  @{ url = 'products/pumping-stations.html'; title = 'სატუმბი სადგური';       kind = 'კატეგორია' },
  @{ url = 'products/pumping-stations.html#dab';  title = 'DAB';           kind = 'ბრენდი' },
  @{ url = 'products/pumping-stations.html#wilo'; title = 'Wilo';          kind = 'ბრენდი' },
  @{ url = 'products/underfloor-heating.html'; title = 'იატაკის გათბობა'; kind = 'კატეგორია' },
  @{ url = 'products/underfloor-heating.html#tiemme'; title = 'TIEMME'; kind = 'ბრენდი' },
...
$staticEn = @(
  ...
  @{ url = 'projects-en.html'; title = 'Featured projects'; kind = 'Page' },
  # hidden for now: @{ url = 'service-en.html';               title = 'Service and technical support'; kind = 'Page' },
  @{ url = 'products/heating-en.html';      title = 'Heating';               kind = 'Category' },
  @{ url = 'products/ducting-fittings-en.html'; title = 'Ducting & fittings'; kind = 'Category' },
  @{ url = 'products/ducting-en.html';      title = 'Ducting';               kind = 'Category' },
  @{ url = 'products/grilles-en.html';      title = 'Grilles';               kind = 'Category' },
  @{ url = 'products/accessories-en.html';  title = 'Ducting accessories';   kind = 'Category' },
  ...
  @{ url = 'products/pumping-stations-en.html'; title = 'Pumping stations'; kind = 'Category' },
  @{ url = 'products/pumping-stations-en.html#dab';  title = 'DAB';         kind = 'Brand' },
  @{ url = 'products/pumping-stations-en.html#wilo'; title = 'Wilo';        kind = 'Brand' },
  @{ url = 'products/underfloor-heating-en.html'; title = 'Underfloor heating'; kind = 'Category' },
  @{ url = 'products/underfloor-heating-en.html#tiemme'; title = 'TIEMME'; kind = 'Brand' },
