...
window.crl8.EventBus.dispatchEvent('initializeCuralatePixel', { pixelId: 122021, useDebug: false, cookieConsent: false });
window.crl8.EventBus.dispatchEvent('siteReady', { name: 'samsungau-rjiff0' });
}